...
export const ONBOARDING_STEPS: OnboardingStep[] = [
  ...
  {
    eyebrow: "雇一个专人，而不是开一次聊天",
    title: "数字专家：长期驻留的 Agent 实例",
    subtitle: "独立工作目录、独立记忆、自己的定时任务——它会自己持续干活并复盘进化。",
    bullets: [
      {
        icon: "memory",
        title: "身份与记忆都独立",
        body: "每个专家有自己的工作目录和记忆，与你的个人助手互不干扰；侧边栏「数字专家」可查看它在跑什么。",
      },
      {
        icon: "clock",
        title: "案例：自主选股",
        body: "内置「A股投资」专家：工作日收盘后自动取数、按规则决策、用虚拟账本（100 万本金）下单，全程留痕。",
      },
      {
        icon: "review",
        title: "每周复盘，越用越准",
        body: "周五晚它对照本周每笔决策的预期与实际，写复盘、改规则、沉淀教训——规则每天都在贴近真实市场。",
      },
    ],
  },
  {
